...
# We the information provide by simple K-nn techniques and run some regression  from age of 20 66 years old 
# in the last part we used the model provided as a reference, and run some data  using different boroughs 
